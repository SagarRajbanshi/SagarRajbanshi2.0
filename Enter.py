# Decompile by Sagar Rajbanshi(Tools By Cobra-Linux Sagar Rajbanshi)
# Dont ader restiment with DEVIL
# Decode file /- NA Cobra  3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +9779827395590
import os
import time
os.system("clear")
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/DEVIL-NAJMUL/J/blob/main/Premium.txt"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/SagarRajbanshi/J/blob/main/Premium.txt').text
			if basesplit in plr:
				key = basesplit
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Social Media  ] \n")
		print(" [*] Facebook  : https://facebook.com/SagarRajbanshiofficial.profile")
		print(" [*] Instagram : https://instagram.com/Sagar._.Rajbanshi")
		print(" [*] YouTube   : https://youtube.com/SagarRajbanshi")
		exit(" [*] GitHub    : https://github.com/SagarRajbanshi")
	else:
		Main()
